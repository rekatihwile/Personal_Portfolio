  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-14 md:py-16">
      ...
      <section className="mb-20 grid gap-10 md:grid-cols-2 md:items-start">
        ...
        <div>
          <h2 className="mb-3 text-2xl font-semibold">Perception And Item Recognition</h2>
          <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-20 grid gap-10 md:grid-cols-2 md:items-start">
        <div>
          <h2 className="mb-3 text-2xl font-semibold">Hardware Prototype</h2>
          <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mb-16 grid gap-12 md:grid-cols-2">
        <div>
          <h2 className="mb-5 text-2xl font-semibold">Engineering Takeaways</h2>
