        ...
        <div className="w-full max-w-6xl px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr,0.8fr] gap-10 items-center justify-items-center">
            ...
            <img
              ...
              className="w-48 h-48 md:w-64 md:h-64 rounded-xl object-cover justify-self-center border border-white/10"
            />
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-6xl px-4 py-12">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mx-auto max-w-5xl justify-items-center">
          <Link
            ...
            className="group rounded-xl border border-white/10 bg-[#0f1213] hover:bg-white/[0.04] p-4 transition"
          >
            <img
              src="/images/Ball_Catching_Robot/Experimental_Setup.png"
              alt="CAD render for the ball-catching arm"
            ...
            <p className="mt-1 text-sm text-gray-400">
              Computer vision + 2‑DOF arm to intercept ping‑pong trajectories; multiple controllers
              benchmarked.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-400">
              Non‑invasive 3D‑printed strap attachment for improved playability without drilling.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-400">Custom Built Ukulele Attachment.</p>
          </Link>
        </div>
      </section>
    </div>
