...
<a href="mailto:eli.p.p.whitaker@gmail.com" className="text-sm underline decoration-dotted underline-offset-4 hover:text-white">eli.p.p.whitaker@gmail.com</a>
</div>
...
<a href="/Eli_Whitaker_Resume.pdf" className="hover:text-white">Resume</a>
</div>
</div>
<p className="mt-6 text-xs text-gray-500">© {new Date().getFullYear()} Eli Whitaker. All rights reserved.</p>
</div>
</footer>
);
}